...
function Presentation() {
  ...
  const {writeContractAsync: writeTx3} = useWriteContract(); //hub wagmi write in contract
...
//----------------------------------------
  const definitiveJudgment = async (e) => {
    e.preventDefault(); 

    toast.success('Final judgment digital evidence satisfactorily recorded', { autoClose: 2000 });
    setShowEvidenceDataTable(false);
    setShowBlockchainTable(true);
        ...
        <div className="w-[20%] flex flex-col items-center justify-center bg-neutral-900 text-white ">
          <div className="mb-4 mt-[-20px]">
            <h2 className="text-2xl font-semibold text-white text-center">
              ...
              Presentation of the results of the analysis performed and documented in detailed, 
              structured and understandable technical and executive reports.
              </h3>
          </div>
          <div className="mb-4">     
          </div>
  ...
  {/*----------------------------------------*/}    
      ...
      <form className="w-[60%] bg-gray-50 rounded-7 px-8 p-6 pb-3 mt-10" id="form2">
          <div className="form-group border-b border-gray-300 pb-7 pt-7">
              ...
              Report final judgment on acceptance of the digital evidence by 
              the judicial entity assigned to the forensic investigation case.</h2>      
            </div>
                ...
                {[
                  ...
                  <div key={option.value} className="flex flex-col items-center ">
                    <input
                      ...
                      name="decision"
                      value={option.value}
                      checked={formData2.decision === option.value}
