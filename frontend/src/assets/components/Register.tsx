...
//const API = process.env.REACT_APP_API;//URL backend
...
//----------------------------------------
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      setFileName(selectedFile.name);  // Actualizar el estado con el nombre del archivo
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
            <div className="text-center">
              {fileName ? (
                  <span className="text-lg text-gray-700">{fileName}</span>  // Mostrar el nombre del archivo
                ) : (
