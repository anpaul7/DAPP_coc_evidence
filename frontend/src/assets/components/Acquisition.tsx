...
import {  FcButtingIn, FcDataProtection, FcDocument, FcFilingCabinet, FcFolder, FcInspection, FcKey, FcManager, FcMultipleDevices, FcNook,  FcPlanner, FcReadingEbook, FcReuse, FcRules, FcSafe,  FcSupport, FcSurvey, FcTodoList } from 'react-icons/fc';
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    >
                      ...
                      <input id="file-upload" 
                            name="file" 
                            type="file" 
                            accept=".docx,.log,.csv,.pdf,.mp4,.png,.jpg,.zip,.txt,.sql"
                            className="sr-only"
                            onChange={handleFileChange}
                      />      
                    </label>
                  </div>
                  <p className="text-xs/4 text-gray-600"> DOCX, LOG, CSV, PDF, TXT, ZIP, SQL, MP4, JPG, PNG</p>
                </div>
              </div> 
