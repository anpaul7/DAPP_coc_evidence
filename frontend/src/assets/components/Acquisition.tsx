            ...
            <button
              ...
              className={`rounded-md px-3 py-2 text-sm-md font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 
                ${formData2.userType.trim() && formData2.idType.trim() && formData2.id.trim() &&
                  ...
                  formData2.filePath.trim() && formData2.datepicker.trim() && !isRegistering ? "bg-green-500 text-dark hover:bg-green-400 focus-visible:outline-indigo-600" : "bg-gray-300 text-gray-500 cursor-not-allowed"}
              `}
              onClick={registerAsk}
              disabled={
                !formData2.userType.trim() || !formData2.idType.trim() || !formData2.id.trim() || 
